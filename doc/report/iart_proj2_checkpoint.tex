...
\begin{itemize}
  \item Reinforcement learning has also been applied to BRP; \cite{jiang2021} provides a framework for reinforcement learning on BRP, and applies an heuristic function and $\epsilon$-greedy strategy.
...
\textbf{Summary:} game and puzzle generation implemented, human interface implemented, beginning to implement machine learning algorithms
